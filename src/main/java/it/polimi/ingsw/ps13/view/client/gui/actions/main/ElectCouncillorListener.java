...
public class ElectCouncillorListener extends GUIListener {
	...
	public ElectCouncillorListener(Collection<GUIRegion> regions, Collection<GUICouncillor> councillors, GUIForm form, ClientConnection connection, JButton confirmButton) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		form.append("[INFO] Elect Councillor selected. Please choose balcony and councillor");
